...
public class Utility extends ManageBrowser {
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/com/nopcommerce/dem/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/com/nopcommerce/dem/screenshots/" + screenshotName + dateName + ".png";
